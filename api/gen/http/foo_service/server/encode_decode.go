...
func marshalFooserviceFieldWithExtensionToFieldWithExtensionResponse(v *fooservice.FieldWithExtension) *FieldWithExtensionResponse {
	...
	if v.BarField != nil {
		res.BarField = marshalFooserviceBarToBarResponse(v.BarField)
	}

	return res
}

// marshalFooserviceBarToBarResponse builds a value of type *BarResponse from a
